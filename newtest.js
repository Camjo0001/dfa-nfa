...
Node.prototype.draw = function(c) {
	...
	c.stroke();
    c.fillStyle = styles.state === 'none' ? 'rgba(0,0,0,0.01)' : styles.state;
	...
	if(this.isAcceptState) {
		...
		c.stroke();
        c.fillStyle = styles.state === 'none' ? 'rgba(0,0,0,0.01)' : styles.final;
...
function restoreBackup() {
	...
	try {
        ...
        document.getElementById('bgcolor').value = backup.styles.bg
        document.getElementById('statecolor').value = backup.styles.state
        document.getElementById('startcolor').value = backup.styles.start
        document.getElementById('finalcolor').value = backup.styles.final
        document.getElementById('canvas').style.backgroundColor = backup.styles.bg
...
function updateStyles() { 
    ...
    let statecolor = document.getElementById('statecolor').value;
...
// Attach a click event listener to the button
  ...
  link.download = `${Math.floor(Math.random() * 1000000000)}.png`;
  link.href = pngData;
  link.click()
  link.remove()
